...
#define	MAKEINT(i)				(((int32_t) (i)) << kRefTagBits)
#define	MAKEIMMED(t, v)		((((((int32_t) (v)) << kRefImmedBits) | ((int32_t) (t))) << kRefTagBits) | kTagImmed)
#define	MAKECHAR(c)				MAKEIMMED(kImmedChar, (unsigned) c)
#define	MAKEBOOLEAN(b)			(b ? TRUEREF : FALSEREF)
#define	MAKEPTR(p)				((Ref)((char*)p + 1))
#define	MAKEMAGICPTR(index)	((Ref) (((int32_t) (index)) << kRefTagBits) | kTagMagicPtr)
...
inline int32_t	RINT(Ref r)		{ return ISINT(r) ? RVALUE(r) : _RINTError(r); }
...
inline				RefVar::operator	int32_t() const
{ return h->ref; }
