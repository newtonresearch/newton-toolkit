...
- (void) drawDividerInRect:(NSRect)inRect
{
	...
	if (txt && txt.length > 0)
	{
		...
		box.origin.y += 13.0;
		[self lockFocus];
		[txt drawWithRect:box options:0 attributes:[NSDictionary dictionaryWithObjectsAndKeys:[NSFont systemFontOfSize:NSFont.smallSystemFontSize], NSFontAttributeName,
